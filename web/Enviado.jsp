...
<html>
    ...
    <body>
        ...
        <div align="center" style="margin: 100px">
            <h1>Mensaje enviado correctamente</h1><br>
            
            <td><a href="Controlador?menu=Habitaciones&accion=Listar" class="btn btn-primary" id="confirmar">Sigue mirando las habitaciones</a></td>
        </div>
